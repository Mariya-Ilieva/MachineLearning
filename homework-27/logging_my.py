...
if __name__ == '__main__':
    root_logger = basicConfig(level=DEBUG, format_str='%(asctime)s - %(name)s - %(levelname)s - %(message)s')
    ...
    file_handler = FileHandler('logfile.txt', mode='w', level=DEBUG)
    ...
    info('INFO message from global function')
    warning('WARNING message from global function')
    error('ERROR message from global function')
    critical('CRITICAL message from global function')
